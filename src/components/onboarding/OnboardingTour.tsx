...
export const OnboardingTour = ({
  ...
  return (
    <>
      ...
      {/* Tooltip */}
      <div
        className="fixed z-[10000] bg-card border-2 border-lime rounded-xl shadow-2xl p-6 animate-scale-in"
        style={{
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button
              size="sm"
              onClick={onNext}
              className="gap-1 bg-lime text-lime-foreground hover:bg-lime/90"
            >
